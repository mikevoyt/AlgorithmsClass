// quiz_timer.js?time_remaining=%d

(function() {
  window.GET = get_js_query_parameters();
})();

function Quiz_Timer(l_end_time) {
    var end_time;
    var timer_div;
...
$(window).load(function() {
	var quiz_timer = new Quiz_Timer(Math.floor(new Date().getTime() / 1000) + Number(window.GET['time_remaining']));
});
